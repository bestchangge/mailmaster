...
import com.sunlei.mailmaster.remotecontrol.K9RemoteControl;
import com.sunlei.mailmaster.Preferences;
import com.sunlei.mailmaster.R;
import com.sunlei.mailmaster.Account.FolderMode;
import com.sunlei.mailmaster.K9.BACKGROUND_OPS;

import static com.sunlei.mailmaster.remotecontrol.K9RemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.sunlei.mailmaster.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.sunlei.mailmaster.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.sunlei.mailmaster.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.sunlei.mailmaster.service.RemoteControlService");
