...
import com.sunlei.mailmaster.AccountStats;
import com.sunlei.mailmaster.K9;
import com.sunlei.mailmaster.K9.NotificationHideSubject;
import com.sunlei.mailmaster.K9.Intents;
import com.sunlei.mailmaster.K9.NotificationQuickDelete;
import com.sunlei.mailmaster.NotificationSetting;
import com.sunlei.mailmaster.Preferences;
import com.sunlei.mailmaster.R;
import com.sunlei.mailmaster.activity.Accounts;
import com.sunlei.mailmaster.activity.FolderList;
import com.sunlei.mailmaster.activity.MessageList;
import com.sunlei.mailmaster.activity.MessageReference;
import com.sunlei.mailmaster.activity.NotificationDeleteConfirmation;
import com.sunlei.mailmaster.activity.setup.AccountSetupCheckSettings.CheckDirection;
import com.sunlei.mailmaster.activity.setup.AccountSetupIncoming;
import com.sunlei.mailmaster.activity.setup.AccountSetupOutgoing;
import com.sunlei.mailmaster.cache.EmailProviderCache;
import com.sunlei.mailmaster.helper.Contacts;
import com.sunlei.mailmaster.helper.power.TracingPowerManager;
import com.sunlei.mailmaster.helper.power.TracingPowerManager.TracingWakeLock;
import com.sunlei.mailmaster.mail.Address;
import com.sunlei.mailmaster.mail.FetchProfile;
import com.sunlei.mailmaster.mail.Flag;
import com.sunlei.mailmaster.mail.Folder;
import com.sunlei.mailmaster.mail.Folder.FolderType;
...
import com.sunlei.mailmaster.mail.PushReceiver;
import com.sunlei.mailmaster.mail.Pusher;
import com.sunlei.mailmaster.mail.Store;
...
import com.sunlei.mailmaster.mail.store.LocalStore;
import com.sunlei.mailmaster.mail.store.LocalStore.LocalFolder;
import com.sunlei.mailmaster.mail.store.LocalStore.LocalMessage;
import com.sunlei.mailmaster.mail.store.LocalStore.PendingCommand;
import com.sunlei.mailmaster.mail.store.Pop3Store;
import com.sunlei.mailmaster.mail.store.UnavailableAccountException;
import com.sunlei.mailmaster.mail.store.UnavailableStorageException;
import com.sunlei.mailmaster.provider.EmailProvider;
import com.sunlei.mailmaster.provider.EmailProvider.StatsColumns;
import com.sunlei.mailmaster.search.ConditionsTreeNode;
import com.sunlei.mailmaster.search.LocalSearch;
import com.sunlei.mailmaster.search.SearchAccount;
import com.sunlei.mailmaster.search.SearchSpecification;
import com.sunlei.mailmaster.search.SqlQueryBuilder;
import com.sunlei.mailmaster.service.NotificationActionService;
...
public class MessagingController implements Runnable {
    ...
    private static final String PENDING_COMMAND_MOVE_OR_COPY = "com.sunlei.mailmaster.MessagingController.moveOrCopy";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK = "com.sunlei.mailmaster.MessagingController.moveOrCopyBulk";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK_NEW = "com.sunlei.mailmaster.MessagingController.moveOrCopyBulkNew";
    private static final String PENDING_COMMAND_EMPTY_TRASH = "com.sunlei.mailmaster.MessagingController.emptyTrash";
    private static final String PENDING_COMMAND_SET_FLAG_BULK = "com.sunlei.mailmaster.MessagingController.setFlagBulk";
    private static final String PENDING_COMMAND_SET_FLAG = "com.sunlei.mailmaster.MessagingController.setFlag";
    private static final String PENDING_COMMAND_APPEND = "com.sunlei.mailmaster.MessagingController.append";
    private static final String PENDING_COMMAND_MARK_ALL_AS_READ = "com.sunlei.mailmaster.MessagingController.markAllAsRead";
    private static final String PENDING_COMMAND_EXPUNGE = "com.sunlei.mailmaster.MessagingController.expunge";
