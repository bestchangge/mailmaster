package com.sunlei.mailmaster.preferences;
...
import com.sunlei.mailmaster.K9.Theme;
import com.sunlei.mailmaster.R;
import com.sunlei.mailmaster.Account.SortType;
import com.sunlei.mailmaster.preferences.Settings.*;
    ...
    public static class ThemeSetting extends SettingsDescription {
        ...
        public Object fromString(String value) throws InvalidSettingValueException {
            try {
                ...
                else if (theme == K9.Theme.RED.ordinal() || theme == android.R.style.Theme) {
                    return K9.Theme.RED;
                }
