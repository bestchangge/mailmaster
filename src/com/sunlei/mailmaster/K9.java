...
import com.sunlei.mailmaster.Account.SortType;
import com.sunlei.mailmaster.activity.MessageCompose;
import com.sunlei.mailmaster.activity.UpgradeDatabases;
...
import com.sunlei.mailmaster.mail.internet.BinaryTempFileBody;
import com.sunlei.mailmaster.mail.store.LocalStore;
import com.sunlei.mailmaster.provider.UnreadWidgetProvider;
import com.sunlei.mailmaster.security.LocalKeyStore;
import com.sunlei.mailmaster.service.BootReceiver;
import com.sunlei.mailmaster.service.MailService;
import com.sunlei.mailmaster.service.ShutdownReceiver;
import com.sunlei.mailmaster.service.StorageGoneReceiver;
...
public class K9 extends Application {
	 ...
	 * {@link #registerApplicationAware(com.sunlei.mailmaster.K9.ApplicationAware)}
	 * will immediately call
	 * {@link com.sunlei.mailmaster.K9.ApplicationAware#initializeComponent(K9)}
	...
	public static class Intents {
		...
		public static class EmailReceived {
			public static final String ACTION_EMAIL_RECEIVED = "com.sunlei.mailmaster.intent.action.EMAIL_RECEIVED";
			public static final String ACTION_EMAIL_DELETED = "com.sunlei.mailmaster.intent.action.EMAIL_DELETED";
			public static final String ACTION_REFRESH_OBSERVER = "com.sunlei.mailmaster.intent.action.REFRESH_OBSERVER";
			public static final String EXTRA_ACCOUNT = "com.sunlei.mailmaster.intent.extra.ACCOUNT";
			public static final String EXTRA_FOLDER = "com.sunlei.mailmaster.intent.extra.FOLDER";
			public static final String EXTRA_SENT_DATE = "com.sunlei.mailmaster.intent.extra.SENT_DATE";
			public static final String EXTRA_FROM = "com.sunlei.mailmaster.intent.extra.FROM";
			public static final String EXTRA_TO = "com.sunlei.mailmaster.intent.extra.TO";
			public static final String EXTRA_CC = "com.sunlei.mailmaster.intent.extra.CC";
			public static final String EXTRA_BCC = "com.sunlei.mailmaster.intent.extra.BCC";
			public static final String EXTRA_SUBJECT = "com.sunlei.mailmaster.intent.extra.SUBJECT";
			public static final String EXTRA_FROM_SELF = "com.sunlei.mailmaster.intent.extra.FROM_SELF";
		}

		public static class Share {
			/*
			 * We don't want to use EmailReceived.EXTRA_FROM
			 * ("com.sunlei.mailmaster.intent.extra.FROM") because of different
			 * semantics (String array vs. string with comma separated email
			 * addresses)
			 */
			public static final String EXTRA_FROM = "com.sunlei.mailmaster.intent.extra.SENDER";
		}
	}
	...
	public static void loadPrefs(Preferences prefs) {
		...
		int themeValue = sprefs.getInt("theme", Theme.RED.ordinal());
		...
		} else if (themeValue == Theme.LIGHT.ordinal()
				|| themeValue == android.R.style.Theme) {
	 ...
	 */
	public enum Theme {
		RED, LIGHT, DARK, USE_GLOBAL
	}

	public static int getK9ThemeResourceId(Theme themeId) {
		return (themeId == Theme.RED) ? R.style.Theme_K9_Red
				: ((themeId == Theme.LIGHT) ? R.style.Theme_K9_Light
